# 27.	The credit card number consists of 16 digits. In a separate module, define a function f(card_number) that masks the card number. 
...
def f(card_number):
    card_mod = card_number[:2] + "*"*10 + card_number[12:]
    return card_mod
